...
#     | bash -s -- --repo gitee --base-url https://ir.example.com
#
...
case "$REPO" in
    github) GIT_URL="git+ssh://git@github.com/gujialind/InvestRing.git#subdirectory=ir-cli" ;;
    gitee)  GIT_URL="git+ssh://git@gitee.com/collyns_Gu/invest-ring.git#subdirectory=ir-cli" ;;
    git+*)  GIT_URL="$REPO" ;;  # 允许直接传完整 pip 风格 git URL
