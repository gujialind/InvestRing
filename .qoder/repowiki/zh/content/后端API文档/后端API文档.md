...
## 更新摘要
**所做更改**
- 增强了OpenAPI规范生成功能，portfolio路由和schema现在包含更完整的响应模型定义
- NavHistoryRecord模型的使用得到完善，提供更准确的净值历史数据结构
- openapi.json规范已扩展54行，涵盖五个高频命令的schema定义
- 更新了投资组合管理相关的API文档，反映增强的响应模型结构
- 完善了OpenAPI规范管理章节，详细说明新的规范生成流程
...
**更新** OpenAPI规范生成功能得到显著增强，portfolio路由和schema现在包含更完整的响应模型定义，特别是NavHistoryRecord模型的使用。openapi.json规范已扩展54行，涵盖五个高频命令的schema定义，包括投资组合净值历史、收益统计、现金流等关键端点的完整数据结构描述。
...
- 接口清单
  - GET /api/portfolios
    ...
    - 响应体：分页对象
    - 示例路径：[组合列表示例:18-36](file://backend/app/routers/portfolios.py#L18-36)
  - POST /api/portfolios
    - 请求体：PortfolioCreate
    - 响应体：PortfolioResponse
    - 示例路径：[创建组合示例:39-58](file://backend/app/routers/portfolios.py#L39-58)
  - GET /api/portfolios/{code}
    - 响应体：PortfolioResponse
    - 示例路径：[获取组合示例:61-70](file://backend/app/routers/portfolios.py#L61-70)
  - PUT /api/portfolios/{code}
    - 请求体：PortfolioUpdate
    - 响应体：PortfolioResponse
    - 示例路径：[更新组合示例:73-89](file://backend/app/routers/portfolios.py#L73-89)
  - POST /api/portfolios/{code}/close
    - 响应体：{"message": "..."}
    - 示例路径：[关闭组合示例:92-131](file://backend/app/routers/portfolios.py#L92-131)
  - POST /api/portfolios/{code}/reactivate
    - 响应体：{"message": "..."}
    - 示例路径：[重新激活组合示例:134-156](file://backend/app/routers/portfolios.py#L134-156)
  - GET /api/portfolios/{code}/nav-history
    ...
    - 示例路径：[净值历史示例:159-191](file://backend/app/routers/portfolios.py#L159-191)
  - GET /api/portfolios/{code}/returns
    - 响应体：累计收益、年化收益、初始/当前净值、持有天数
    - 示例路径：[收益统计示例:194-241](file://backend/app/routers/portfolios.py#L194-241)
  - GET /api/portfolios/{code}/cash-flow
    - 响应体：流入、流出、净流入
    - 示例路径：[现金流示例:244-275](file://backend/app/routers/portfolios.py#L244-275)

**更新** 投资组合净值历史端点现在使用NavHistoryRecord模型，提供更完整的响应数据结构，包括标准化的日期格式、数值精度和单位净值计算逻辑。OpenAPI规范已更新以反映这些改进。

**章节来源**
- [backend/app/routers/portfolios.py:18-276](file://backend/app/routers/portfolios.py#L18-276)
...
- 接口清单
  - GET /api/products
    ...
    - 响应体：分页对象
    - 示例路径：[产品列表示例:27-45](file://backend/app/routers/products.py#L27-45)
  - POST /api/products
    - 请求体：ProductCreate
    - 响应体：ProductResponse
    - 示例路径：[创建产品示例:48-76](file://backend/app/routers/products.py#L48-76)
  - GET /api/products/{code}/{market}
    - 响应体：ProductResponse
    - 示例路径：[获取产品示例:79-92](file://backend/app/routers/products.py#L79-92)
  - PUT /api/products/{code}/{market}
    - 请求体：ProductUpdate
    - 响应体：ProductResponse
    - 示例路径：[更新产品示例:95-122](file://backend/app/routers/products.py#L95-122)
  - DELETE /api/products/{code}/{market}
    - 响应体：{"message": "..."}
    - 示例路径：[删除产品示例:125-141](file://backend/app/routers/products.py#L125-141)

**章节来源**
- [backend/app/routers/products.py:27-142](file://backend/app/routers/products.py#L27-142)
...
- 接口清单
  - GET /api/platforms
    - 查询参数：page、page_size
    - 响应体：分页对象
    - 示例路径：[平台列表示例:12-27](file://backend/app/routers/platforms.py#L12-27)
  - POST /api/platforms
    - 请求体：PlatformCreate
    - 响应体：PlatformResponse
    - 示例路径：[创建平台示例:30-44](file://backend/app/routers/platforms.py#L30-44)
  - GET /api/platforms/{code}
    - 响应体：PlatformResponse
    - 示例路径：[获取平台示例:47-55](file://backend/app/routers/platforms.py#L47-55)
  - PUT /api/platforms/{code}
    - 请求体：PlatformUpdate
    - 响应体：PlatformResponse
    - 示例路径：[更新平台示例:59-75](file://backend/app/routers/platforms.py#L59-75)
  - DELETE /api/platforms/{code}
    - 响应体：{"message": "..."}
    - 示例路径：[删除平台示例:78-90](file://backend/app/routers/platforms.py#L78-90)

**章节来源**
- [backend/app/routers/platforms.py:12-91](file://backend/app/routers/platforms.py#L12-91)
...
- 接口清单
  - GET /api/positions
    ...
    - 响应体：分页对象（默认返回最新快照）
    - 示例路径：[持仓列表示例:180-218](file://backend/app/routers/positions.py#L180-218)
  - POST /api/positions
    - 请求体：PositionCreate
    - 响应体：PositionResponse
    - 示例路径：[创建持仓示例:221-231](file://backend/app/routers/positions.py#L221-231)
  - GET /api/positions/{id}
    - 响应体：PositionResponse
    - 示例路径：[获取持仓示例:234-243](file://backend/app/routers/positions.py#L234-243)
  - PUT /api/positions/{id}
    - 请求体：PositionUpdate
    - 响应体：PositionResponse
    - 示例路径：[更新持仓示例:246-262](file://backend/app/routers/positions.py#L246-262)
  - DELETE /api/positions/{id}
    - 响应体：{"message": "..."}
    - 示例路径：[删除持仓示例:265-277](file://backend/app/routers/positions.py#L265-277)
  - GET /api/positions/portfolio/{portfolio_code}/available-cash
    - 响应体：{"portfolio_code": "...", "available_cash": number}
    - 示例路径：[可用现金示例:280-293](file://backend/app/routers/positions.py#L280-293)
  - GET /api/positions/portfolio/{portfolio_code}/product/{product_code}/available-shares
    ...
    - 示例路径：[可用份额示例:296-316](file://backend/app/routers/positions.py#L296-316)
  - POST /api/positions/portfolio/{portfolio_code}/cash-position
    ...
    - 示例路径：[更新现金头寸示例:319-409](file://backend/app/routers/positions.py#L319-409)

**章节来源**
- [backend/app/routers/positions.py:180-410](file://backend/app/routers/positions.py#L180-410)
...
- 接口清单
  - GET /api/trades
    ...
    - 响应体：分页对象（按创建时间倒序）
    - 示例路径：[交易列表示例:271-289](file://backend/app/routers/trades.py#L271-289)
  - POST /api/trades
    - 请求体：TradeCreate（buy/sell 类型、金额/份额、价格、费用、交易日期等）
    - 响应体：TradeResponse（状态默认 pending）
    - 权限：管理员；交易日校验；可用现金/份额校验；自动计算份额与金额
    - 示例路径：[创建交易示例:292-402](file://backend/app/routers/trades.py#L292-402)
  - GET /api/trades/{id}
    - 响应体：TradeResponse
    - 示例路径：[获取交易示例:405-414](file://backend/app/routers/trades.py#L405-414)
  - POST /api/trades/{id}/confirm
    ...
    - 示例路径：[确认交易示例:417-504](file://backend/app/routers/trades.py#L417-504)
  - POST /api/trades/{id}/cancel
    - 响应体：{"message": "..."}
    - 权限：管理员；仅场外 pending 可取消
    - 示例路径：[取消交易示例:507-532](file://backend/app/routers/trades.py#L507-532)
  - PUT /api/trades/{id}
    - 请求体：TradeUpdate
    - 响应体：TradeResponse
    - 示例路径：[更新交易示例:535-551](file://backend/app/routers/trades.py#L535-551)
  - DELETE /api/trades/{id}
    - 响应体：{"message": "..."}
    - 示例路径：[删除交易示例:554-566](file://backend/app/routers/trades.py#L554-566)

**更新** 新增PRICE_NAV_MISMATCH错误码：在处理场外基金交易确认时，如果客户端提供的价格与系统获取的基金净值不一致，将返回此错误码。这有助于确保交易价格的准确性和一致性。

**章节来源**
- [backend/app/routers/trades.py:271-567](file://backend/app/routers/trades.py#L271-567)
...
- 接口清单
  - POST /api/v1/snapshots/generate
    ...
    - 示例路径：[生成快照示例:28-55](file://backend/app/routers/snapshots.py#L28-55)
  - POST /api/v1/snapshots/recalculate
    ...
    - 示例路径：[重算快照示例:58-87](file://backend/app/routers/snapshots.py#L58-87)
  - GET /api/v1/snapshots/validation
    - 查询参数：portfolio_code、target_date
    - 响应体：SnapshotValidationResult
    - 示例路径：[依赖预检示例:90-111](file://backend/app/routers/snapshots.py#L90-111)
  - GET /api/v1/snapshots/portfolios/{code}/status
    - 响应体：SnapshotStatusResponse（最新/最早快照日期、总数、缺失日期列表）
    - 示例路径：[快照状态示例:114-157](file://backend/app/routers/snapshots.py#L114-157)
  - DELETE /api/v1/snapshots/{portfolio_code}/{snapshot_date}
    - 响应体：{"success": true, "message": "..."}
    - 示例路径：[删除快照示例:160-187](file://backend/app/routers/snapshots.py#L160-187)

**章节来源**
- [backend/app/routers/snapshots.py#L28-L188:28-188](file://backend/app/routers/snapshots.py#L28-188)
...
- 接口清单
  - GET /api/system/tasks
    - 查询参数：page、page_size
    - 响应体：分页对象
    - 示例路径：[任务列表示例:70-85](file://backend/app/routers/tasks.py#L70-85)
  - POST /api/system/tasks/{code}/run
    - 响应体：根据任务类型返回不同结果（如净值同步后的统计）
    - 支持任务：trading_calendar_sync、nav_sync、log_cleanup
    - 示例路径：[运行任务示例:88-267](file://backend/app/routers/tasks.py#L88-267)
  - POST /api/system/tasks/{code}/enable
    - 响应体：{"message": "..."}
    - 示例路径：[启用任务示例:270-282](file://backend/app/routers/tasks.py#L270-282)
  - POST /api/system/tasks/{code}/disable
    - 响应体：{"message": "..."}
    - 示例路径：[禁用任务示例:285-297](file://backend/app/routers/tasks.py#L285-297)
  - GET /api/system/tasks/{code}/logs
    - 查询参数：page、page_size
    - 响应体：分页对象（任务执行日志）
    - 示例路径：[任务日志示例:300-322](file://backend/app/routers/tasks.py#L300-322)

**章节来源**
- [backend/app/routers/tasks.py#L70-L323:70-323](file://backend/app/routers/tasks.py#L70-323)
...
- 接口清单
  - GET /api/subscriptions
    ...
    - 响应体：分页对象（按创建时间倒序）
    - 示例路径：[订阅列表示例:88-112](file://backend/app/routers/subscriptions.py#L88-112)
  - POST /api/subscriptions
    - 请求体：SubscriptionCreate（subscribe/redeem 类型、金额/份额、申请日期）
    - 响应体：SubscriptionResponse（状态默认 pending）
    - 权限：管理员；交易日校验；可用份额校验（赎回）
    - 示例路径：[创建订阅示例:115-199](file://backend/app/routers/subscriptions.py#L115-199)
  - GET /api/subscriptions/{id}
    - 响应体：SubscriptionResponse
    - 权限：普通用户仅能查看自己的记录
    - 示例路径：[获取订阅示例:202-213](file://backend/app/routers/subscriptions.py#L202-213)
  - POST /api/subscriptions/{id}/confirm
    - 查询参数：confirm_date（可选）、unit_price（可选）
    - 响应体：确认结果与 SubscriptionResponse
    - 权限：管理员；首次申购净值固定；赎回需提供净值
    - 示例路径：[确认订阅示例:237-320](file://backend/app/routers/subscriptions.py#L237-320)
  - POST /api/subscriptions/{id}/cancel
    - 响应体：{"message": "..."}
    - 权限：管理员；仅 pending 可取消
    - 示例路径：[取消订阅示例:323-340](file://backend/app/routers/subscriptions.py#L323-340)
  - PUT /api/subscriptions/{id}
    - 请求体：SubscriptionUpdate
    - 响应体：SubscriptionResponse
    - 示例路径：[更新订阅示例:343-359](file://backend/app/routers/subscriptions.py#L343-359)
  - DELETE /api/subscriptions/{id}
    - 响应体：{"message": "..."}
    - 示例路径：[删除订阅示例:362-374](file://backend/app/routers/subscriptions.py#L362-374)

**章节来源**
- [backend/app/routers/subscriptions.py#L88-L375:88-375](file://backend/app/routers/subscriptions.py#L88-375)
...
- 接口清单
  - GET /api/system/data-sources
    ...
    - 示例路径：[数据源列表示例:1594-1618](file://backend/app/routers/data_sources.py#L1594-1618)
  - GET /api/system/data-sources/{name}
    - 响应体：单个数据源配置
    - 示例路径：[数据源详情示例:1619-1674](file://backend/app/routers/data_sources.py#L1619-1674)
  - PUT /api/system/data-sources/{name}
    - 请求体：DataSourceUpdate
    - 响应体：更新后的数据源配置
    - 示例路径：[更新数据源示例:1675-1700](file://backend/app/routers/data_sources.py#L1675-1700)

**章节来源**
- [backend/app/routers/data_sources.py#L1594-L1700:1594-1700](file://backend/app/routers/data_sources.py#L1594-1700)
...
- 接口清单
  - GET /api/market-data/products/{code}/{market}/price-data
    ...
    - 响应体：价格数据列表
    - 示例路径：[产品价格数据示例:1675-1788](file://backend/app/routers/market_data.py#L1675-1788)
  - POST /api/market-data/products/{code}/{market}/sync-price-data
    - 请求体：同步请求参数
    - 响应体：同步结果
    - 示例路径：[同步价格数据示例:1789-1854](file://backend/app/routers/market_data.py#L1789-1854)
  - POST /api/market-data/products/{code}/{market}/sync-history
    - 请求体：历史数据同步参数
    - 响应体：同步结果
    - 示例路径：[同步历史数据示例:1855-1903](file://backend/app/routers/market_data.py#L1855-1903)
  - POST /api/market-data/portfolios/{portfolio_code}/sync-nav
    - 请求体：净值同步参数
    - 响应体：同步结果
    - 示例路径：[同步组合净值示例:1904-1943](file://backend/app/routers/market_data.py#L1904-1943)
  - **新增** GET /api/market-data/portfolios/{portfolio_code}/nav-coverage
    ...
    - 示例路径：[净值覆盖率验证示例:1944-2000](file://backend/app/routers/market_data.py#L1944-2000)
...
**章节来源**
- [backend/app/routers/market_data.py#L1675-L2000:1675-2000](file://backend/app/routers/market_data.py#L1675-2000)
...
- 接口清单
  - GET /api/logs/system-error-logs
    ...
    - 响应体：系统错误日志分页列表
    - 示例路径：[系统错误日志示例:1-200](file://backend/app/routers/logs.py#L1-200)
  - GET /api/logs/login-logs
    - 查询参数：investor_code、start_time、end_time、page、page_size
    - 响应体：登录日志分页列表
    - 示例路径：[登录日志示例:1-200](file://backend/app/routers/logs.py#L1-200)
  - GET /api/logs/audit-logs
    - 查询参数：investor_code、operation、start_time、end_time、page、page_size
    - 响应体：审计日志分页列表
    - 示例路径：[审计日志示例:1-200](file://backend/app/routers/logs.py#L1-200)

**章节来源**
- [backend/app/routers/logs.py#L1-L200:1-200](file://backend/app/routers/logs.py#L1-200)
...
- 接口清单
  - GET /api/notifications
    ...
    - 响应体：通知分页列表
    - 示例路径：[通知列表示例:1-200](file://backend/app/routers/notifications.py#L1-200)
  - POST /api/notifications/mark-as-read
    - 请求体：标记已读请求
    - 响应体：操作结果
    - 示例路径：[标记已读示例:1-200](file://backend/app/routers/notifications.py#L1-200)
  - POST /api/notifications/mark-all-as-read
    - 请求体：无
    - 响应体：操作结果
    - 示例路径：[全部标记已读示例:1-200](file://backend/app/routers/notifications.py#L1-200)

**更新** 新增完整的通知系统API端点，支持通知查询、标记已读和批量操作功能。管理员可以通过这些接口管理系统通知，包括按投资者、阅读状态和时间范围筛选通知，以及批量标记通知为已读状态。

**章节来源**
- [backend/app/routers/notifications.py#L1-L200:1-200](file://backend/app/routers/notifications.py#L1-200)
...
- 接口清单
  - GET /api/share-change-events
    - 查询参数：portfolio_code、page、page_size
    - 响应体：份额变动事件分页列表
    - 示例路径：[份额事件列表示例:28-46](file://backend/app/routers/share_change_events.py#L28-46)
  - POST /api/share-change-events
    - 请求体：ShareChangeEventCreate（包含 portfolio_code、event_type、ex_date、entitlement_date 等）
    - 响应体：创建后的事件
    - 示例路径：[创建份额事件示例:49-77](file://backend/app/routers/share_change_events.py#L49-77)
  - GET /api/share-change-events/{id}
    - 响应体：单个份额变动事件
    - 示例路径：[份额事件详情示例:80-89](file://backend/app/routers/share_change_events.py#L80-89)
  - PUT /api/share-change-events/{id}
    - 请求体：ShareChangeEventUpdate
    - 响应体：更新后的事件
    - 示例路径：[更新份额事件示例:151-167](file://backend/app/routers/share_change_events.py#L151-167)
  - DELETE /api/share-change-events/{id}
    - 响应体：删除结果
    - 示例路径：[删除份额事件示例:170-182](file://backend/app/routers/share_change_events.py#L170-182)
  - POST /api/share-change-events/{id}/confirm
    - 响应体：确认结果
    - 权限：管理员；校验权益登记日持仓快照存在
    - 示例路径：[确认份额事件示例:92-128](file://backend/app/routers/share_change_events.py#L92-128)
  - POST /api/share-change-events/{id}/cancel
    - 响应体：{"message": "..."}
    - 权限：管理员；仅 pending 状态可取消
    - 示例路径：[取消份额事件示例:131-148](file://backend/app/routers/share_change_events.py#L131-148)
...
- 接口清单
  - GET /api/trading-calendar
    ...
    - 响应体：交易日历列表
    - 示例路径：[交易日历列表示例:1431-1546](file://backend/app/routers/trading_calendar.py#L1431-1546)
  - POST /api/trading-calendar/sync
    - 请求体：TradingCalendarSyncRequest
    - 响应体：同步结果
    - 示例路径：[同步交易日历示例:1547-1593](file://backend/app/routers/trading_calendar.py#L1547-1593)

**章节来源**
- [backend/app/routers/trading_calendar.py#L1431-L1593:1431-1593](file://backend/app/routers/trading_calendar.py#L1431-1593)
...
**章节来源**
- [backend/app/main.py:17-L21:17-21](file://backend/app/main.py#L17-L21)
...
- 包含完整的请求/响应模式定义
- **新增**：包含nav-coverage端点的完整定义和参数说明
- **更新**：规范文件已扩展54行，涵盖五个高频命令的schema定义，特别是投资组合相关的净值历史、收益统计、现金流等端点的完整数据结构
...
**图表来源**
- [backend/app/routers/trades.py#L417-L504:417-504](file://backend/app/routers/trades.py#L417-L504)
...
**图表来源**
- [backend/app/routers/market_data.py#L1944-L2000:1944-2000](file://backend/app/routers/market_data.py#L1944-L2000)
...
**图表来源**
- [backend/app/routers/portfolios.py#L159-L191:159-191](file://backend/app/routers/portfolios.py#L159-L191)
- [backend/openapi.json#L1-L200:1-200](file://backend/openapi.json#L1-L200)