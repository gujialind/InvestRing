...
## 更新摘要
**变更内容**
- 新增单个任务查询接口 GET /api/system/tasks/{code}
- 修复任务日志生成中的500错误，解决response_model不匹配问题
- 增强CLI任务命令，添加describe功能
...
**最新更新**：新增了单个任务查询接口，增强了CLI任务管理功能，修复了日志生成的错误处理问题。
...
#### 单个任务查询（新增）
- **URL**: `/api/system/tasks/{code}`
- **HTTP方法**: GET
- **权限**: 需要管理员权限
- **路径参数**:
  - code: 任务代码
- **响应**: 返回指定任务的详细信息，包括任务配置、状态和执行历史
...
**最新更新**：新增的单个任务查询接口提升了任务管理的灵活性，修复的任务日志生成问题提高了系统稳定性，增强的CLI功能改善了开发者体验。